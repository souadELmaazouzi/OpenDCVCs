        ...
        if args.global_best_dir:
            ...
            if current_best_loss < global_best_loss:
                ...
                global_best_path = os.path.join(
                    ...
                    f'model_dcvc_lambda_{args.lambda_value}_quality_{args.quality_index}_global_best.pth'
                )
                ...
                global_best_state_dict_path = os.path.join(
                    args.global_best_dir,
                    f'model_dcvc_lambda_{args.lambda_value}_quality_{args.quality_index}_global_best_state_dict.pth'
                )
